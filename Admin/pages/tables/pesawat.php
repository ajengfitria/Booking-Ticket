...
if(@$_SESSION['adminticketing']){
  ...
  <head>
    ...
    <title>BestTravel | Pesawat</title>
            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Daftar Pesawat</h3>
                </div>
                <div class="box-body">
                      ...
                      <tbody>
                        ...
                        if(mysqli_num_rows($sql) == 0){
                          ...
                          while($row = mysqli_fetch_assoc($sql)){
                            ...
                            echo '
                            <center>
                            <a href="../edit/pesawat.php?id_trans='.$row['id_trans'].'"title="Edit" class="btn btn-sm"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                            <a href="../delete/pesawat.php?aksi=delete&id_trans='.$row['id_trans'].'"title="Hapus" onclick="return confirm(\'Data Akan Dihapus?\')"class="btn btn-sm"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                            </td>
                            </tr>
                            ';
                            $id++;
