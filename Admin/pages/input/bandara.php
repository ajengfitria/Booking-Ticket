...
if(@$_SESSION['adminticketing']){
  ...
  if (isset($_POST['Input'])){
    ...
    $cn->query("INSERT INTO bandara (id_bandara,nama_bandara,id_kota) VALUES ('$id_bandara','$nama_bandara','$id_kota')");
  ...
  <head>
    ...
    <title>BestTravel | Input Bandara</title>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="../input/bandara.php"><i class="fa fa-circle-o"></i> Input Bandara</a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Input Bandara</li>
          </ol>
        </section>
        ...
        <section class="content">
         <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">Input Daftar Bandara</h3>
          </div>
          <form role="form" method="POST">
            <div class="box-body">
              <div class="form-group">
                <label for="Nama Bandara">Nama Bandara</label>
                <input type="text" class="form-control" id="nama_bandara" placeholder="Nama Bandara" name="nama_bandara" required="">
              </div>
              <div class="form-group">
                ...
                <select class="form-control" name="id_kota" required="">
                  ...
                  if(mysqli_num_rows($sql) > 0){
                    while($data = mysqli_fetch_assoc($sql)){
                      echo '<option value="'.$data['id_kota'].'">'.$data['kota'].'</option>';
                    }
                  }
                  ?>
                </select>
