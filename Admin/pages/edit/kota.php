...
if(@$_SESSION['adminticketing']){
  ...
  $res = $cn->query("SELECT * FROM kota WHERE id_kota='$ambilid'");
  $data = $res->fetch_array(MYSQLI_ASSOC);

  if (isset($_POST['Edit'])){
    $kota = $_POST['kota'];
    $update = $cn->query("UPDATE kota SET kota='$kota' WHERE id_kota='$ambilid'");
  ...
  <head>
    ...
    <title>BestTravel | Edit Kota</title>
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="../tables/kota.php"><i class="fa fa-circle-o"></i> Daftar Kota</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
          ...
          <form role="form" method="POST">
            <div class="box-body">
              <div class="form-group">
                <label for="Nama Kota">Kota</label>
                <input type="text" class="form-control" id="Nama Kota" placeholder="Nama Kota" name="kota" value="<?php echo $data['kota'] ?>">
              </div>
            </div>
            <div class="box-footer">
              <button type="button" class="btn btn-primary"><a href="../tables/kota.php" style="color: #FFFFFF;">Cancel</a></button>
