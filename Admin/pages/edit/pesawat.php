...
if(@$_SESSION['adminticketing']){
  ...
  $res = $cn->query("SELECT * FROM transport WHERE id_trans='$ambilid'");
  ...
  if (isset($_POST['Edit'])){
    ...
    $update = $cn->query("UPDATE transport SET nama_trans='$nama_trans', kode_trans='$kode_trans', jml='$jml', deskripsi='$deskripsi' WHERE id_trans='$ambilid'");
  ...
  <head>
    ...
    <title>BestTravel | Edit Pesawat</title>
    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar">
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Daftar Pesawat</li>
          </ol>
        </section>
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="../tables/pesawat.php"><i class="fa fa-circle-o"></i> Daftar Pesawat</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Beranda</a></li>
            <li class="active">Edit Pesawat</li>
          </ol>
        </section>
          ...
          <form role="form" method="POST">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nama_trans" placeholder="Nama Pesawat" name="nama_trans" value="<?php echo $data['nama_trans'] ?>">
                </div>
                <div class="form-group">
                  <label for="kode_trans">Kode Pesawat</label>
                  <input type="text" class="form-control" id="kode_trans" placeholder="Kode Pesawat" name="kode_trans" value="<?php echo $data['kode_trans'] ?>">
                </div>
                <div class="form-group">
                  <label for="jml">Seat</label>
                  <input type="text" class="form-control" id="jml" placeholder="Seat" name="jml" value="<?php echo $data['jml'] ?>">
                </div>
                <div class="form-group">
                  <label for="deskripsi">Deskripsi</label>
                  <input type="text" class="form-control" id="deskripsi" placeholder="Deskripsi" name="deskripsi" value="<?php echo $data['deskripsi'] ?>">
                </div>
              </div>
              <!-- /.box-body -->
