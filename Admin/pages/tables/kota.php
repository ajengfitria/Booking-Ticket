                      ...
                      <tbody>
                        ...
                        if(mysqli_num_rows($sql) == 0){
                          ...
                          while($row = mysqli_fetch_assoc($sql)){
                            ...
                            echo '
                            <center>
                            <a href="../edit/kota.php?id_kota='.$row['id_kota'].'"title="Edit" class="btn btn-sm"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                            <a href="../delete/kota.php?aksi=delete&id_kota='.$row['id_kota'].'"title="Hapus" onclick="return confirm(\'Data Akan Dihapus?\')"class="btn btn-sm"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                            </td>
                            </tr>
                            ';
                            $id++;
