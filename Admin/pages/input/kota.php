...
if(@$_SESSION['adminticketing']){
  ...
  if (isset($_POST['Input'])){
    $kota = $_POST['kota'];
    $cn->query("INSERT INTO kota (kota) VALUES ('$kota')");
...
<head>
  ...
  <title>BestTravel | Input Kota</title>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="../input/kota.php"><i class="fa fa-circle-o"></i> Input Kota</a></li>
    ...
    <section class="content">
         <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">Input Daftar Kota</h3>
          </div>
          <form role="form" method="POST">
            <div class="box-body">
              <div class="form-group">
                <label for="Kota">Kota</label>
                <input type="text" class="form-control" id="Kota" placeholder="Nama Kota" name="kota" required="">
              </div>
            </div>
